...
export interface HomeDashboardProps {
  initialAnalysis?: MatchPreviewResponse | null;
  initialResume?: ResumeGenerateResponse | null;
}

export function HomeDashboard({
  initialAnalysis = DEFAULT_MATCH,
  initialResume = DEFAULT_RESUME,
}: HomeDashboardProps = {}) {
  ...
  // Resultados de IA
  const [activeAnalysis, setActiveAnalysis] = useState<MatchPreviewResponse | null>(initialAnalysis);
  const [activeResume, setActiveResume] = useState<ResumeGenerateResponse | null>(initialResume);
